...
public interface IDg<T extends IDg> {
    ...
    T setPositiveButton(CharSequence text, OnClickListener listener);

    T setNegativeButton(CharSequence text, OnClickListener listener);

    T setNeutralButton(CharSequence text, OnClickListener listener);
