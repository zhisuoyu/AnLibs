package org.zsy.libs.utils.reference;
...
public final class ToastUtils {
    ...
    private final static ToastCreator DefaultCreator = new ToastCreator() {
        @Override
    ...
    public static void setToastCreator(ToastCreator toastCreator) {
        ToastUtils.toastCreator = toastCreator;
    }

    private static Toast createToast(Context context, CharSequence text, int duration) {
        ToastCreator creator = toastCreator == null ? DefaultCreator : toastCreator;
        return creator.create(context, text, duration);
    }
    ...
    public static void showLong(CharSequence text) {
        show(Utils.getAppContext(), text, Toast.LENGTH_LONG);
    }


    public interface ToastCreator {
        Toast create(Context context, CharSequence text, int duration);
    }
...
//            public void run() {
//                cancel();
//                final Toast toast = Toast.makeText(Utils.getAppContext(), text, duration);
...
//            public void run() {
//                cancel();
//                final Toast toast = new Toast(Utils.getAppContext());
//                sWeakToast = new WeakReference<>(toast);
//
//                toast.setView(view);
...
//                (LayoutInflater) Utils.getAppContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
